...
OPCODES = {
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.INTERPRETIVE: {
            ...
            "STCALL": Interpretive("Store",         "STCALL",   034001, 2),
            "STODL":  Interpretive("Store",         "STODL",    014001, 2),
            "STODL*": Interpretive("Store",         "STODL*",   014001, 2),
            "STORE":  Interpretive("Store",         "STORE",    000000, 1),
            "STOVL":  Interpretive("Store",         "STOVL",    024001, 2),
            "STOVL*": Interpretive("Store",         "STOVL*",   024001, 2),
            ...
            "VSU":    Interpretive("VSU",           "VSU",      0131,   1),
            "VSU*":   Interpretive("VSU",           "VSU*",     0133,   1),
