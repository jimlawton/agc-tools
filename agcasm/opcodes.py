...
OPCODES = {
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.INTERPRETIVE: {
            ...
            # Name                 Method           Mnemonic    Opcode	Operands	Type                        Argcode
            ...
            "AXT,1":  Interpretive("Index",         "AXT,1",    0006,   1),
            "AXT,2":  Interpretive("Index",         "AXT,2",    0002,   1),
            ...
            "BOF":    Interpretive("Switch",        "BOF",      0162,   2,  		InterpretiveType.SWITCH,    016),
            "BOFCLR": Interpretive("Switch",        "BOFCLR",   0162,   2,  		InterpretiveType.SWITCH,    012),
            "BOFF":   Interpretive("Switch",        "BOFF",     0162,   2,  		InterpretiveType.SWITCH,    016),
            "BOFINV": Interpretive("Switch",        "BOFINV",   0162,   2,  		InterpretiveType.SWITCH,    006),
            "BOFSET": Interpretive("Switch",        "BOFSET",   0162,   2,  		InterpretiveType.SWITCH,    002),
            "BON":    Interpretive("Switch",        "BON",      0162,   2,  		InterpretiveType.SWITCH,    014),
            "BONCLR": Interpretive("Switch",        "BONCLR",   0162,   2,  		InterpretiveType.SWITCH,    010),
            "BONINV": Interpretive("Switch",        "BONINV",   0162,   2,  		InterpretiveType.SWITCH,    004),
            "BONSET": Interpretive("Switch",        "BONSET",   0162,   2,  		InterpretiveType.SWITCH,    000),
            ...
            "CLEAR":  Interpretive("Switch",        "CLEAR",    0162,   1,  		InterpretiveType.SWITCH,    013),
            "CLR":    Interpretive("Switch",        "CLR",      0162,   1,  		InterpretiveType.SWITCH,    013),
            "CLRGO":  Interpretive("Switch",        "CLRGO",    0162,   2,  		InterpretiveType.SWITCH,    011),
            ...
            "INVERT": Interpretive("Switch",        "INVERT",   0162,   1,  		InterpretiveType.SWITCH,    007),
            "INVGO":  Interpretive("Switch",        "INVGO",    0162,   2,  		InterpretiveType.SWITCH,    005),
            ...
            "SET":    Interpretive("Switch",        "SET",      0162,   1,  		InterpretiveType.SWITCH,    003),
            "SETGO":  Interpretive("Switch",        "SETGO",    0162,   2,  		InterpretiveType.SWITCH,    001),
            ...
            "SL":     Interpretive("Shift",         "SL",       0115,   1,  		InterpretiveType.SHIFT,     0202),
            "SL*":    Interpretive("Shift",         "SL*",      0117,   1,  		InterpretiveType.SHIFT,     0202),
            ...
            "SLR":    Interpretive("Shift",         "SLR",      0115,   1,  		InterpretiveType.SHIFT,     0212),
            "SLR*":   Interpretive("Shift",         "SLR*",     0117,   1,  		InterpretiveType.SHIFT,     0212),
            "SQRT":   Interpretive("SQRT",          "SQRT",     0010,   0),
            "SR":     Interpretive("Shift",         "SR",       0115,   1,  		InterpretiveType.SHIFT,     0206),
            "SR*":    Interpretive("Shift",         "SR*",      0117,   1,  		InterpretiveType.SHIFT,     0206),
            ...
            "SRR":    Interpretive("Shift",         "SRR",      0115,   1,  		InterpretiveType.SHIFT,     0216),
            "SRR*":   Interpretive("Shift",         "SRR*",     0117,   1,  		InterpretiveType.SHIFT,     0216),
            ...
            "STODL*": Interpretive("Store",         "STODL*",   020000, 2),
            "STORE":  Interpretive("Store",         "STORE",    000000, 1),
            "STOVL":  Interpretive("Store",         "STOVL",    024000, 2),
            "STOVL*": Interpretive("Store",         "STOVL*",   030000, 2),
            ...
            "TIX,1":  Interpretive("Index",         "TIX,1",    0076,   1),
            "TIX,2":  Interpretive("Index",         "TIX,2",    0072,   1),
            ...
            "VSL":    Interpretive("Shift",         "VSL",      0115,   1,  		InterpretiveType.SHIFT,     0202),
            "VSL*":   Interpretive("Shift",         "VSL*",     0117,   1,  		InterpretiveType.SHIFT,     0202),
            "VSL1":   Interpretive("VSL1",          "VSL1",     0004,   0),
            "VSL2":   Interpretive("VSL2",          "VSL2",     0024,   0),
            "VSL3":   Interpretive("VSL3",          "VSL3",     0044,   0),
            "VSL4":   Interpretive("VSL4",          "VSL4",     0064,   0),
            "VSL5":   Interpretive("VSL5",          "VSL5",     0104,   0),
            "VSL6":   Interpretive("VSL6",          "VSL6",     0124,   0),
            "VSL7":   Interpretive("VSL7",          "VSL7",     0144,   0),
            "VSL8":   Interpretive("VSL8",          "VSL8",     0164,   0),
            "VSQ":    Interpretive("VSQ",           "VSQ",      0140,   0),
            "VSR":    Interpretive("Shift",         "VSR",      0115,   1,  		InterpretiveType.SHIFT,     0206),
            "VSR*":   Interpretive("Shift",         "VSR*",     0117,   1,  		InterpretiveType.SHIFT,     0206),
            "VSR1":   Interpretive("VSR1",          "VSR1",     0014,   0),
            "VSR2":   Interpretive("VSR2",          "VSR2",     0034,   0),
            "VSR3":   Interpretive("VSR3",          "VSR3",     0054,   0),
            "VSR4":   Interpretive("VSR4",          "VSR4",     0074,   0),
            "VSR5":   Interpretive("VSR5",          "VSR5",     0114,   0),
            "VSR6":   Interpretive("VSR6",          "VSR6",     0134,   0),
            "VSR7":   Interpretive("VSR7",          "VSR7",     0154,   0),
            "VSR8":   Interpretive("VSR8",          "VSR8",     0174,   0),
