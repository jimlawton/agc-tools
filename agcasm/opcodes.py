...
OPCODES = {
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.INTERPRETIVE: {
            ...
            # Name                 Method           Mnemonic    Opcode	Operands	Type                        Switchcode
            ...
            "BOF":    Interpretive("BOF",           "BOF",      0162,   2,  		InterpretiveType.SWITCH,    000341),
            "BOFCLR": Interpretive("BOFCLR",        "BOFCLR",   0162,   2,  		InterpretiveType.SWITCH,    000241),
            "BOFF":   Interpretive("BOFF",          "BOFF",     0162,   2,  		InterpretiveType.SWITCH,    000341),
            "BOFINV": Interpretive("BOFINV",        "BOFINV",   0162,   2,  		InterpretiveType.SWITCH,    000141),
            "BOFSET": Interpretive("BOFSET",        "BOFSET",   0162,   2,  		InterpretiveType.SWITCH,    000041),
            "BON":    Interpretive("BON",           "BON",      0162,   2,  		InterpretiveType.SWITCH,    000301),
            "BONCLR": Interpretive("BONCLR",        "BONCLR",   0162,   2,  		InterpretiveType.SWITCH,    000201),
            "BONINV": Interpretive("BONINV",        "BONINV",   0162,   2,  		InterpretiveType.SWITCH,    000101),
            "BONSET": Interpretive("BONSET",        "BONSET",   0162,   2,  		InterpretiveType.SWITCH,    000001),
            ...
            "CLEAR":  Interpretive("CLEAR",         "CLEAR",    0162,   1,  		InterpretiveType.SWITCH,    000261),
            "CLR":    Interpretive("CLR",           "CLR",      0162,   1,  		InterpretiveType.SWITCH,    000261),
            "CLRGO":  Interpretive("CLRGO",         "CLRGO",    0162,   2,  		InterpretiveType.SWITCH,    000221),
            ...
            "INVERT": Interpretive("INVERT",        "INVERT",   0162,   1,  		InterpretiveType.SWITCH,    000161),
            "INVGO":  Interpretive("INVGO",         "INVGO",    0162,   2,  		InterpretiveType.SWITCH,    000121),
            ...
            "SET":    Interpretive("SET",           "SET",      0162,   1,  		InterpretiveType.SWITCH,    000061),
            "SETGO":  Interpretive("SETGO",         "SETGO",    0162,   2,  		InterpretiveType.SWITCH,    000021),
            ...
            "SL":     Interpretive("SL",            "SL",       0115,   1,  		InterpretiveType.SHIFT,     020202),
            "SL*":    Interpretive("SL",            "SL*",      0117,   1,  		InterpretiveType.SHIFT,     020202),
            ...
            "SLR":    Interpretive("SLR",           "SLR",      0115,   1,  		InterpretiveType.SHIFT,     021202),
            "SLR*":   Interpretive("SLR",           "SLR*",     0117,   1,  		InterpretiveType.SHIFT,     021202),
            "SQRT":   Interpretive("SQRT",          "SQRT",     0010,   0),
            "SR":     Interpretive("SR",            "SR",       0115,   1,  		InterpretiveType.SHIFT,     020602),
            "SR*":    Interpretive("SR",            "SR*",      0117,   1,  		InterpretiveType.SHIFT,     020602),
            ...
            "SRR":    Interpretive("SRR",           "SRR",      0115,   1,  		InterpretiveType.SHIFT,     021602),
            "SRR*":   Interpretive("SRR",           "SRR*",     0117,   1,  		InterpretiveType.SHIFT,     021602),
            ...
            "VSL":    Interpretive("VSL",           "VSL",      0115,   1,  		InterpretiveType.SHIFT,     020202),
            "VSL*":   Interpretive("VSL",           "VSL*",     0117,   1,  		InterpretiveType.SHIFT,     020202),
            ...
            "VSR":    Interpretive("VSR",           "VSR",      0115,   1,  		InterpretiveType.SHIFT,     020602),
            "VSR*":   Interpretive("VSR",           "VSR*",     0117,   1,  		InterpretiveType.SHIFT,     020602),
