...
OPCODES = {
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.INTERPRETIVE: {
            ...
            "CCALL":  Interpretive("CCALL",         "CCALL",    0065,   2,          True),
            "CCALL*": Interpretive("CCALL",         "CCALL*",   0067,   2,          True),
            "CGOTO":  Interpretive("CGOTO",         "CGOTO",    0021,   2,          True),
            "CGOTO*": Interpretive("CGOTO",         "CGOTO*",   0023,   2,          True),
            ...
            "STODL":  Interpretive("Store",         "STODL",    014000, 2,          True),
            "STODL*": Interpretive("Store",         "STODL*",   020000, 2,          True),
            "STORE":  Interpretive("Store",         "STORE",    000000, 1,          True),
            "STOVL":  Interpretive("Store",         "STOVL",    024000, 2,          True),
            "STOVL*": Interpretive("Store",         "STOVL*",   030000, 2,          True),
