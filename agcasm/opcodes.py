...
OPCODES = {
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.INTERPRETIVE: {
            ...
            "STCALL": Interpretive("Store",         "STCALL",   034001),
            "STODL":  Interpretive("Store",         "STODL",    014001),
            "STODL*": Interpretive("Store",         "STODL*",   014001),
            "STORE":  Interpretive("Store",         "STORE",    000001),
            "STOVL":  Interpretive("Store",         "STOVL",    024001),
            "STOVL*": Interpretive("Store",         "STOVL*",   024001),
