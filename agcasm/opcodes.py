...
OPCODES = { 
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.DIRECTIVE: {
            ...
            "2BCADR":   Directive("2CADR",          "2BCADR",   OperandType.EXPRESSION, 2),
            ...
            "=":        Directive("EQUALS",         "=",        OperandType.EXPRESSION, 0),
            ...
            "MM":       Directive("DEC",            "MM",       OperandType.DECIMAL,    1),
            "NV":       Directive("VN",             "NV",       OperandType.DECIMAL,    1),
            "OCT":      Directive("OCT",            None,       OperandType.OCTAL,      1),
            "OCTAL":    Directive("OCT",            "OCTAL",    OperandType.OCTAL,      1),
