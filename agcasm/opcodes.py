...
OPCODES = { 
    Architecture.AGC4_B2 : {
        ...
        OpcodeType.DIRECTIVE: {
            ...
            "-3DNADR":  Directive("Minus3DNADR",    "-3DNADR",  OperandType.EXPRESSION, False,      1),
            "-4DNADR":  Directive("Minus4DNADR",    "-4DNADR",  OperandType.EXPRESSION, False,      1),
            "-5DNADR":  Directive("Minus5DNADR",    "-5DNADR",  OperandType.EXPRESSION, False,      1),
            "-6DNADR":  Directive("Minus6DNADR",    "-6DNADR",  OperandType.EXPRESSION, False,      1),
            ...
            "1DNADR":   Directive("1DNADR",         None,       OperandType.EXPRESSION, False,      1),
            ...
            "2DNADR":   Directive("2DNADR",         None,       OperandType.EXPRESSION, False,      1),
            "2FCADR":   Directive("2FCADR",         None,       OperandType.EXPRESSION, False,      2), 
            "2OCT":     Directive("2OCT",           None,       OperandType.OCTAL,      False,      2),
            "3DNADR":   Directive("3DNADR",         None,       OperandType.EXPRESSION, False,      1),
            "4DNADR":   Directive("4DNADR",         None,       OperandType.EXPRESSION, False,      1),
            "5DNADR":   Directive("5DNADR",         None,       OperandType.EXPRESSION, False,      1),
            "6DNADR":   Directive("6DNADR",         None,       OperandType.EXPRESSION, False,      1),
